package com.sqli.nespresso.dishes.dishes;
 ...
 *
 * L'objectif de l'exercice est de mesurer la qualité du signal pour une chaine d'un satellite donné sur une échelle de 10, en fonction des paraboles disponibles.<br/>
 * Chaque écart de 0,1° avec le bon satellite affaiblit le signal par -1. Avec plus de 1° de déviation, le signal est perdu complètement.<br/><br/>
 *
